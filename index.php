            ...
            <div class="tp-banner">
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="">
                        <!-- MAIN IMAGE -->
                        <img src="asset/img/bg-1.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        ...
                        <div class="caption text sfl"
                             ...
                             data-start="1800"
                             data-easing="easeOutExpo">
                            Gezilerimizden resimler, hikayeler.  <br>
                            yaşananlar. Oranın hikayeleri sizleri alıp oralara götüreceğiz.  
                        </div>
                    </li>
                    <!-- SLIDE -->
                    <li data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="">
                        <!-- MAIN IMAGE -->
                        <img src="asset/img/bg-2.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
...
<br><br>
                    ...
                    <li data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="">
                        <!-- MAIN IMAGE -->
                        <img src="asset/img/bg-3.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
...
<br><br>
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="#">
                    <img class="img-responsive" src="asset/img/1.png" alt="">
                </a>
            </div>
            <div class="col-md-5">
                <h3>Nevşehir - (Capadocia)</h3>
                <h4>Bir şeker bayramı kaçamağı</h4>
                <p>Doğa ve tarihin dünyada en güzel bütünleştiği yerdir. Coğrafik olaylar Peribacaları'nı oluştururken, tarihi süreçte, insanlar da, bu peribacalarının içlerine ev, kilise oymuş, bunları fresklerle süsleyerek, binlerce yıllık yaşlı medeniyetlerin izlerini günümüze taşımış izler</p>
                <a class="btn btn-primary" href="content.php">Devamı <span class="glyphicon glyphicon-chevron-right"></span></a>
            </div>
        </div>
        <!-- /.row -->
        <hr>
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="#">
                    <img class="img-responsive" src="asset/img/2.png" alt="">
                </a>
            </div>
            <div class="col-md-5">
                <h3>Prag - (Praq)</h3>
                <h4>Yıllık İzin</h4>
                <p>Prag "Altın Şehir", "Doksanların Sol Bankası", "Masal Şehri", "Şehirlerin Anası" ve "Avrupa'nın Kalbi" </p>
                <a class="btn btn-primary" href="content.php">Devamı <span class="glyphicon glyphicon-chevron-right"></span></a>
            </div>
        </div>
        <!-- /.row -->		
